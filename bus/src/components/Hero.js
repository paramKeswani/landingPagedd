        ...
        <div className="hero-container">
          <div id="heroCarousel" className="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval={5000}>
            ...
            <div className="carousel-inner" role="listbox">
              ...
              <div className="carousel-item" style={{backgroundImage: 'url(${https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRp7gjMv0ly11YgfWTXHFy2rRN7fixcH-RyQZ2tUO7iw&s})'}}>
                <div className="carousel-container">
                  <div className="container">
              ...
              <div className="carousel-item" style={{backgroundImage: 'url(${https://stocksnap.io/search/business+building})'}}>
                <div className="carousel-container">
                  <div className="container">
